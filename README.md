...
- **Desktop browsers only.** It needs pointer lock, a mouse and WebGL2. On a phone the menu now
  says so instead of letting you click Deploy into a frozen crosshair.
